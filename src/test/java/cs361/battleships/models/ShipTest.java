...
public class ShipTest {
    ...
    public void testPlaceMinesweeperHorizontaly() {
        ...
        minesweeper.move(2); // south move

        occupiedSquares = minesweeper.getOccupiedSquares();
        ArrayList<Object> expected1 = new ArrayList<>();
        expected1.add(new Square(2, 'A'));
        expected1.add(new Square(2, 'B'));

        assertEquals(expected1, occupiedSquares);

        minesweeper.move(4); // west move
        ...
        assertEquals(expected2, occupiedSquares);
    }
